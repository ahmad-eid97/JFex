<template>
  <section class="services-style-area pt-100 pb-70">
    <div class="container">
      ...
      <div class="row pt-45 justify-content-center" v-if="allServices.services.length >= 1">
        <div v-for="service in allServices.services" :key="service.id" class="col-lg-3 col-sm-6 col-md-4 mb-4"
      ...
      <div class="col-lg-12 col-md-12 text-center">
        <div class="pagination-area">
          <b-pagination v-model="allServices.meta.current_page" :total-rows="allServices.meta.total"
            :per-page="allServices.meta.per_page" aria-controls="my-table" @change="changePage"></b-pagination>
        </div>
      </div>
    </div>
  </section>
